...
public class ServerMain {
    public static void main(String[] args) throws Exception {
        ...
        int port = Integer.parseInt(System.getenv().getOrDefault("IWISH_SERVER_PORT", properties.getProperty("server.port", "5555")));
        String host = System.getenv().getOrDefault("IWISH_SERVER_HOST", properties.getProperty("server.host", "127.0.0.1"));
        ...
        try (ServerSocket server = new ServerSocket(port, 50, InetAddress.getByName(host))) {
            ...
            System.out.println("i-Wish Server started on " + host + ":" + port);
